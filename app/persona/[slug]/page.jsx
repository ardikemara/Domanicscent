...
export default function PersonaDetailPage({ params }) {
  ...
  return (
    <div className="pz" style={{ "--accent": c.accent }}>
      {/* 1. HERO */}
      <section className={"pz-hero" + (c.heroEditorial ? " pz-hero--editorial" : "") + (c.heroEditorialLight ? " pz-hero--editorial-light" : "") + (c.heroEditorialBlush ? " pz-hero--editorial-blush" : "") + (c.heroEditorialGraphite ? " pz-hero--editorial-graphite" : "")} style={{ backgroundImage: `url(${c.heroImg})` }}>
