...
export const products = [
  ...
  },
  {
    ...
    story:
      "Lily Wood adalah parfum fresh yang terasa seperti udara segar setelah hujan di tengah pepohonan. Ringan, unisex, gampang dipakai sehari-hari, dan tetap tahan lama. Litchi dan bergamot yang cerah bertemu mawar dan peony, lalu mendarat di kayu cedar dan vetiver yang membumi. Untuk kamu yang nggak suka diam di satu tempat.",
  },
  {
    slug: "whisper",
    name: "Whisper",
    ...
    story:
      "Whisper adalah parfum vanilla floral yang lembut, berbicara pelan tapi diingat. Buah mirabelle dan pir yang lembut membuka jalan untuk melati dan freesia, lalu ditutup vanila dan sandalwood yang hangat. Keanggunan yang nggak perlu berteriak.",
  },
  {
    slug: "oud-majesty",
    name: "Oud Majesty",
    ...
    seo: {
      ...
      description:
        "Oud Majesty, parfum oud yang bold dan magnetik dengan sentuhan parfum musk. Peach dan apple blossom bertemu wild rose, patchouli, dan oud. Extrait de parfum lokal, dibuat pelan di Indonesia. Rp 329.000, 50 ml.",
    },
